...
public class PlacementGenerator : MonoBehaviour
{
    ...
    [SerializeField, Range(0, 1)] float rotateTowardNormal;
    ...
    public void Generate(){
        ...
        for(int i = 0; i < density; i++){
            ...
            instantiatePrefab.transform.rotation = Quaternion.Lerp(transform.rotation, transform.rotation * Quaternion.FromToRotation(instantiatePrefab.transform.up, hit.normal), rotateTowardNormal);
